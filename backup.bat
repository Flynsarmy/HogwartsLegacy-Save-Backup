...
tasklist /fi "ImageName eq eldenring.exe" /fo csv 2>NUL | find /I "HogwartsLegacy.exe">NUL
...
if "%ERRORLEVEL%"=="1" (
	...
	tar.exe -a -cf "%stamp%" "%localappdata%\Hogwarts Legacy\Saved\SaveGames" 2> NUL
